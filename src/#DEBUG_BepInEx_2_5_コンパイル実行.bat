...
@set BEPINEXCORE=C:\Games\Kiss\COM3D2_5\BepInEx\core
@set OPTS=/noconfig /optimize+ /nologo /nostdlib+ /utf8output /define:DEBUG /define:COM3D25 /define:BEPINEX
...
%CSC% %OPTS% /out:BepInEx.COM3D25.EnhancedMaidEditScene.Plugin.dll .\*.cs
@time /T
@pause
@goto A
